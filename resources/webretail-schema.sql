...
CREATE TABLE `cart_line_item` (
  ...
  UNIQUE KEY `UK_k0orfc0sb0efsnexk36leg8ri` (`cart_id`),
...
CREATE TABLE `city_master` (
  ...
  PRIMARY KEY  (`city_id`),
  UNIQUE KEY `UK_rto58mqa21b56bnkjo1fdac20` (`state_id`),
...
CREATE TABLE `order` (
  ...
  UNIQUE KEY `UK_4nhsyh71j1r0846ahng8ghutm` (`coupon_id`),
  UNIQUE KEY `UK_mh40cn97o5svvy5c32ws9tnvp` (`user_id`),
...
CREATE TABLE `order_line_item` (
  ...
  UNIQUE KEY `UK_68rh7w8s0yt8ii23f4txjfb3l` (`order_id`),
...
CREATE TABLE `party` (
  ...
  UNIQUE KEY `UK_irr41ugoxaaa6cov1gb5yjc03` (`address_id`),
...
CREATE TABLE `payment` (
  ...
  UNIQUE KEY `UK_ehfxmmhar5i5cxqqxsf3f6h2o` (`payment_gateway_id`),
...
CREATE TABLE `payment_transaction` (
  ...
  UNIQUE KEY `UK_8qrrs01smxp31txlwy36q7mam` (`payment_id`),
  UNIQUE KEY `UK_5gwaca4bp4rv7j4kydbbofpa7` (`bank_id`),
...
CREATE TABLE `product_attribute` (
  ...
  UNIQUE KEY `UK_92wd38sgkqbn9cyu0u6gsfpib` (`product_id`),
...
CREATE TABLE `product_image` (
  ...
  UNIQUE KEY `UK_a8243l5b6mtej47854pwmgbdk` (`product_id`),
...
CREATE TABLE `product_review` (
  ...
  UNIQUE KEY `UK_4ek6may8xslt402sef538etxf` (`reviewed_by`),
  UNIQUE KEY `UK_59pjh8ssspqs6yypt6kqxtb8r` (`product_id`),
...
CREATE TABLE `shipment_item` (
  ...
  UNIQUE KEY `UK_owjl9ik3hccdv0aij5yhk99qy` (`shipment_id`),
...
CREATE TABLE `state_master` (
  ...
  UNIQUE KEY `UK_d5lkb3xp12lpp356qux5njm6n` (`country_id`),
...
CREATE TABLE `wish_list_item` (
  ...
  UNIQUE KEY `UK_a41r7m7tq4gnunk2gi7d39joy` (`wish_list_id`),
